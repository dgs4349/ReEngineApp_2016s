...
void MyMesh::Render(matrix4 a_mProjection, matrix4 a_mView, matrix4 a_mWorld)
{
	...
	glUniformMatrix4fv(MVP, 1, GL_FALSE, glm::value_ptr(a_mProjection * a_mView * a_mWorld));
